...
public class AllMarketTickersCache {
  ...
  @JsonProperty("O")
  private String statisticesOpenTime;

  @JsonProperty("C")
  private String statisticesCloseTime;
  ...
  public String getStatisticesOpenTime() {
    return statisticesOpenTime;
  }

  public void setStatisticesOpenTime(String statisticesOpenTime) {
    this.statisticesOpenTime = statisticesOpenTime;
  }

  public String getStatisticesCloseTime() {
    return statisticesCloseTime;
  }

  public void setStatisticesCloseTime(String statisticesCloseTime) {
